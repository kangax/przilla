    ...
    <form onSubmit={handleSubmit}>
      <Flex direction="column" gap="3">
            ...
            >
              <Flex direction="column" align="start" gap="1">
                <Flex align="center" gap="2">
                  ...
                  <Text as="label" htmlFor="finishedWithinTimecap-yes" size="2">
              ...
              <Flex direction="column" align="start" gap="1">
                <Flex align="center" gap="2">
                  ...
                  <Text as="label" htmlFor="finishedWithinTimecap-no" size="2">
        ...
        <Flex direction="row" gap="3" justify="end" mt="4">
          ...
          <Button type="submit" color="green" disabled={submitting} size="3">
            {submitting
              ? isEditMode
                ? "Updating..."
                : "Logging..."
