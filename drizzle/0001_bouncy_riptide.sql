...
*/--> statement-breakpoint
ALTER TABLE `przilla_wod` ADD `timecap` integer;--> statement-breakpoint
...
CREATE INDEX `wod_movement_pk` ON `przilla_wod_movement` (`wod_id`,`movement_id`);--> statement-breakpoint
